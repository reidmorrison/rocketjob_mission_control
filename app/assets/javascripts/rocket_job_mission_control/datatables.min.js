 ...
 * © SpryMedia Ltd - datatables.net/license
 */
(n=>{var a,o;"function"==typeof define&&define.amd?define(["jquery","datatables.net-bs","datatables.net-responsive"],function(e){return n(e,window,document)}):"object"==typeof exports?(a=require("jquery"),o=function(e,d){d.fn.dataTable||require("datatables.net-bs")(e,d),d.fn.dataTable.Responsive||require("datatables.net-responsive")(e,d)},"undefined"==typeof window?module.exports=function(e,d){return e=e||window,d=d||a(e),o(e,d),n(d,0,e.document)}:(o(window,a),module.exports=n(a,window,window.document))):n(jQuery,window,document)})(function(l,e,s){var d=l.fn.dataTable,n=d.Responsive.display,u=n.modal,m=l('<div class="modal fade dtr-bs-modal" role="dialog"><div class="modal-dialog" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button></div><div class="modal-body"/></div></div></div>');return n.modal=function(r){return function(e,d,n,a){if(l.fn.modal){var o,t,i=n();if(!1===i)return!1;if(d){if(!l.contains(s,m[0])||e.index()!==m.data("dtr-row-idx"))return null;m.find("div.modal-body").empty().append(i)}else r&&r.header&&(t=(o=m.find("div.modal-header")).find("button").detach(),o.empty().append('<h4 class="modal-title">'+r.header(e)+"</h4>").prepend(t)),m.find("div.modal-body").empty().append(i),m.data("dtr-row-idx",e.index()).one("hidden.bs.modal",a).appendTo("body").modal();return!0}return u(e,d,n,a)}},d});
