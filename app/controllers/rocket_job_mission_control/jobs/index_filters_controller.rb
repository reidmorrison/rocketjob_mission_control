module RocketJobMissionControl
  module Jobs
    class IndexFiltersController < RocketJobMissionControl::ApplicationController
      ...
      def running
        @jobs = RocketJob::Job.running.only(:record_count, :collect_output, :input_categories, :output_categories, :encrypt, :compress, :slice_size, :priority, :sub_state, :percent_complete, REQUIRED_FIELDS).sort(started_at: :desc)
